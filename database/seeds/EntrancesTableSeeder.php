...
class EntrancesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $entrances = [
            ...
            // [2,"味噌一 三軒茶屋店","大通りに面しており、黒塗りの看板に赤い店名が浮かぶ。","東京都世田谷区 太子堂1-12-38 藤和三軒茶屋コープ1F,1051"."jpeg,ほ"]し
            ...
            // [2,"みるまま","普通の一軒家の外観。明るい看板に店名が記載されている","東京都世田谷区三軒茶屋１丁目３６,1065"."jpeg,閉業"]？
            ...
            // [2,"稲穂","赤提灯で店名の記載あり。細い道に面している","東京都世田谷区三軒茶屋１丁目３６−１３,1068"."jpeg,閉業"]？
